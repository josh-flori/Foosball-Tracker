# /users/josh.flori/desktop/test/bin/python /users/josh.flori/documents/josh-flori/foosball_tracker/convert.py --checkpoint /users/josh.flori/desktop/model.ckpt --model XX --out-path ./export
